...
export function Footer() {
  return (
    <footer className="p-8 bg-purple-950 text-white">
      <div className="flex justify-center py-8">
        <Button className="mx-4 text-black hover:scale-110 duration-200 dark:text-white" variant="outline" size="icon">
          <svg
            width="15"
            height="15"
            viewBox="0 0 15 15"
      ...
      <div className="text-center text-slate-300 text-sm font-light">
